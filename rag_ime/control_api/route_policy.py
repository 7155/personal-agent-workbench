...
def default_route_policy() -> ControlRoutePolicy:
    routes = [
        ...
        _route(ControlPathId.KNOWLEDGE_VAULT, ControlMethod.POST, "/api/knowledge/vault", None, body={"action", "root", "excluded", "vaultId", "noteId", "query", "focusId", "graphMode", "link", "paused", "inbox", "diaryId", "captureFolder", "captureProject", "remoteProcessing", "jevEnabled", "personalDiary", "markdown", "requestId", "project", "date", "includeActivity", "timezone", "sourceRefs", "baseRevision", "before", "after", "reason", "proposalId", "proposalRevision", "statement", "noteIds", "confirm"}, required_body={"action"}),
