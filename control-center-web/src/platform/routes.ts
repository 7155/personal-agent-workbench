...
export const CONTROL_ROUTES = {
  ...
  'knowledgeVault.manage': { method: 'POST', path: '/api/knowledge/vault', body: ['action','root','excluded','vaultId','noteId','query','focusId','graphMode','link','paused','inbox','activityProject', 'diaryId', 'captureFolder', 'captureProject', 'remoteProcessing','jevEnabled','personalDiary','markdown','requestId','project','date','includeActivity','timezone','sourceRefs','baseRevision','before','after','reason','proposalId','proposalRevision','statement','noteIds','confirm'], requiredBody: ['action'] },
  'knowledgeBases.list': {
    method: 'GET',
