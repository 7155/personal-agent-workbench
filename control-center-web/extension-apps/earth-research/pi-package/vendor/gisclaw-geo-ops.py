# GISclaw — deterministic geospatial operation templates, vendored for PAW Earth Agent.
...
"""
gisclaw_geo_ops.py — deterministic GIS operation registry for the `geoprocess` tool.
