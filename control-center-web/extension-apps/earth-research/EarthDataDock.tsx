...
const STATUS_LABELS: Record<string, string> = { completed: '已完成', failed: '失败', running: '运行中', starting: '正在启动', cancelled: '已取消', ready: '可读取', configured_pending: '待连接', unknown: '尚未检查' };
